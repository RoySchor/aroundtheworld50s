...
import "./InstagramEmbedSection.css";
import ErrorBoundary from "../../../components/ErrorBoundary/ErrorBoundary";

const InstagramEmbedSection = ({
  username = "aroundtheworld50s",
  title = "Join me on Instagram",
  className = "",
  highlightColor = "#6ECABB",
  borderColor = "#6CC9B9",
}) => {
  ...
  useEffect(() => {
    ...
    if (originalProcess) {
      window.instgrm.Embeds.process = function() {
        try {
          ...
          console.log("Instagram embed processing failed:", e);
          setError(true);
        }
      };
    }
    ...
    return () => {
      ...
      if (window.instgrm && window.instgrm.Embeds && originalProcess) {
        window.instgrm.Embeds.process = originalProcess;
      }
    };
  }, []);
  ...
  if (error) {
    return (
      <div className="instagram-embed-error">
        <h2 className="instagram-embed-title">
          {title} <span style={{ color: highlightColor }}>@{username}</span>
        </h2>
  ...
  return (
    ...
    >
      <div className={`instagram-embed-section ${className}`}>
        <div className="instagram-embed-container" style={{ borderColor }}>
          <h2 className="instagram-embed-title">
            {title} <span style={{ color: highlightColor }}>@{username}</span>
          </h2>
...
InstagramEmbedSection.propTypes = {
...
InstagramEmbedSection.defaultProps = {
  username: "aroundtheworld50s",
  title: "Join me on Instagram",
  className: "",
  highlightColor: "#6ECABB",
