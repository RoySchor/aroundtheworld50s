import { BlogPostContent } from './UnitedStatesNewYorkPost2.types';
...
const unitedstatesnewyorkContent: BlogPostContent = {
  ...
  path: "united-states-new-york/2",
  header: "📍A 4th of July NYC Spectacle",
...
export const UNITED_STATES_NEW_YORK_POST_2 = createBlogPost(unitedstatesnewyorkContent);
