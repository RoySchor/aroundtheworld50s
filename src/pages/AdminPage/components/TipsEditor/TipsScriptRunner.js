...
const TipsScriptRunner = ({ tip, tipsData }) => {
  ...
  const handleDownloadAndGenerate = () => {
    ...
    const command = `cd /Users/rschor/Desktop/my-projects/around-the-world-50s && python3 scripts/tips_management/tips_manager.py "${downloadPath}"`;
    ...
    <div className="blog-script-runner">
      ...
      <div className="blog-script-content">
        <div className="blog-script-section">
          ...
          <p>Click the button below to download your tips content:</p>
        ...
        {terminalCommand && (
          <div className="blog-script-section">
            ...
            <div className="blog-script-info">
              ...
              <ul>
                <li>✅ Validates your tips content</li>
                ...
                <li>🚀 Makes your tips content live immediately</li>
              </ul>
            </div>
            ...
            <div className="blog-script-success">
              ...
              <ul>
                ...
                <li>Automatic backup and rollback if anything goes wrong</li>
                <li>Changes are committed to your git repository</li>
              </ul>
            </div>
          </div>
        )}
